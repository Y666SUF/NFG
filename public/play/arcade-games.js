    ...
    <div class="vault-game-card hilo-game">
      ...
      <div class="hilo-table">
        ...
        <div class="hilo-actions hidden" id="hiloActions">
          ...
          <button type="button" class="btn secondary block h-cash">Collect</button>
        </div>
      </div>
      <div class="h-out"></div>
    </div>
...
export function mountMinesGame(panel, msgEl, onWallet) {
  ...
  let minePositions = [];
  panel.innerHTML = `
    <div class="game-intro muted">Reveal gems — avoid mines. Collect anytime.</div>
    ${stakeRow(2000)}
    ...
    <div class="mines-hud"><span id="mMult">×1.00</span><button type="button" class="btn accent2 m-cash">Collect</button></div>
